<?php ob_start(); ?>
            ...
            <div class="row">
                ...
                <?php if(!empty($cheapProducts)) { foreach($cheapProducts as $cheapProduct) { ?>
                <div class="col-lg-1 col-sm-6 ms-lg-5">
                    <a href="index.php?action=productSheet&idProduct=<?= $cheapProduct['id'] ?>&idPlatform=<?= $cheapProduct['platform_id'] ?>">
                        <div class="row">
                            <div class="d-flex">
                                <span class="bg-primary text-white px-1 text_sm"><?= $cheapProduct['platform_name'] ?></span><span class="bg-light px-1 text_sm"><?= $cheapProduct['name'] ?></span>
                            </div>
                        </div>
                        <div class="row mt-1">
