...
<form action="index.php?page=2" method="POST" class="row my-5">
    <div class="add" style="display: flex; justify-content: end; margin-top: 10px">
        <a href="index.php?action=addEditions" type="submit" class="btn btn-primary" name="add">Ajouter une édition</a>
    </div>
</form>
        ...
        <tr>
            ...
            <td class="text-center">
                <div class="container">
                    <div class="row">
                        <div class="col">
                            <a href="index.php?action=editEditions&id=<?= $edition['id'] ?>" class="btn btn-warning text-white">
                        ...
                        <div class="col">
                            <a href="index.php?action=deleteEditions&id=<?= $edition['id'] ?>" class="btn btn-danger" onclick="return(confirm('Voulez-vous supprimer ce produit ?'));">
