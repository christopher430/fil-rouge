...
<head>
    ...
    <link rel="stylesheet" href="../assets/css/<?php if(isset($cssName)) {echo $cssName;} else {echo 'index.css';} ?>">
</head>
<body>
            ...
            <nav id="sidebarMenu" class="col-md-3 col-lg-2 d-md-block bg-dark vh-100">
                <div class="position-sticky pt-3 sidebar-sticky">
                    <ul class="nav flex-column">
                        ...
                        <li class="nav-item">
                            <a class="nav-link text-white fs-5" href="index.php?action=sections">
